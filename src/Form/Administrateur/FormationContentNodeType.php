<?php
// src/Form/Administrateur/FormationContentNodeType.php
...
class FormationContentNodeType extends AbstractType
{
    public function buildForm(FormBuilderInterface $b, array $o): void
    {
        ...
        $b
            ...
            ->add('parent', EntityType::class, [
                'class'         => FormationContentNode::class,
    ...
    {
        $r->setDefaults([
            'data_class' => FormationContentNode::class,
        ]);
    }
}
