    ...
    public function buildForm(FormBuilderInterface $b, array $o): void
    {
        ...
        $b
            ->add('titre', TextType::class, [
                ...
                'attr' => [
                    'class' => 'form-control',
                    'placeholder' => 'Excel initial, Caces R489',
                ],
            ])
            ...
            ->add('engin', EntityType::class, [
                ...
                'choice_label' => fn (Engin $e) => trim(
                    ($e->getNom() ?? '') . ($e->getSite() ? ' - ' . $e->getSite()->getNom() : '')
                ),
                'attr' => [
                    'class' => 'form-select js-ts',
                    'data-ts-placeholder' => '- Sélectionner un engin -',
                ],
            ...
            ->add('formateur', EntityType::class, [
                ...
                'attr' => [
                    'class' => 'form-select js-ts',
                    'data-ts-placeholder' => '- Sélectionner un formateur -',
                ],
                'query_builder' => function (EntityRepository $er) use ($entite) {
            ...
            ->add('satisfactionTemplate', EntityType::class, [
                ...
                'attr' => [
                    'class' => 'form-select js-ts',
                    'data-ts-placeholder' => 'Aucun template',
                ],
                'query_builder' => function (EntityRepository $er) use ($entite) {
            ...
            ->add('publicHosts', EntityType::class, [
                ...
                'query_builder' => function (EntityRepository $er) use ($entite) {
                    return $er->createQueryBuilder('ph')
                        ->andWhere('ph.entite = :e')
                        ->setParameter('e', $entite)
                        ->orderBy('ph.name', 'ASC');
                },
            ])
            ...
            ->add('categorie', EntityType::class, [
                ...
                'attr' => [
                    'class' => 'form-select rounded-3 shadow-sm js-ts',
                    'data-ts-placeholder' => '- Sélectionner -',
                ],
            ]);
